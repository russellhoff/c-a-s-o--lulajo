...
namespace PracticaCaso
{
	class TcpClient {
		...
		public:
			...
			void send(string msg); //normalmente se usará este método para enviar mensajes
	...
	class TcpListener {
		...
		public:
			TcpListener(int p);
			~TcpListener();
			void start(); //este metodo se lanza solo
			void stop(); //este metodo se lanza solo
			TcpClient *acceptTcpClient(); //este metodo se lanza solo
