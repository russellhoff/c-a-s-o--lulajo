...
int main(int argc, char** argv) {
	...
	PracticaCaso::TcpClient client; //declaracion del objeto de forma estatica
	/*
	 * si lo declaramos con * como puntero, se hace new TcpClient() y se usa -> en vez de . para acceder a sus metodos
	 */
